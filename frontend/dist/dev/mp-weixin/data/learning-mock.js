...
const mockLearningStats = {
  ...
  likedContents: 8,
  collectedContents: 5,
  totalLearningTime: 210,
  // 分钟
  avgLearningTime: 18,
  completionRate: 48,
  continuousLearning: 7,
  lastLearningTime: (/* @__PURE__ */ new Date()).toISOString()
};
const mockArticles = [
  {
    id: 1,
...
const getAllMockContents = () => {
  return [...mockArticles, ...mockVideos, ...mockAudios].sort(
    (a, b) => new Date(b.createdAt) - new Date(a.createdAt)
  );
};
const getContentsByType = (contentType) => {
...
const searchMockContents = (keyword) => {
  const allContents = getAllMockContents();
  if (!keyword) return [];
  const lowerKeyword = keyword.toLowerCase();
  return allContents.filter(
    (content) => content.title.toLowerCase().includes(lowerKeyword) || content.summary.toLowerCase().includes(lowerKeyword) || content.tags.toLowerCase().includes(lowerKeyword)
  );
};
const getPaginatedContents = (contents, page = 1, pageSize = 10) => {
...
exports.featuredCourse = featuredCourse;
exports.getAllMockContents = getAllMockContents;
exports.getContentsByType = getContentsByType;
exports.getPaginatedContents = getPaginatedContents;
exports.mockArticles = mockArticles;
exports.mockAudios = mockAudios;
exports.mockLearningStats = mockLearningStats;
exports.mockVideos = mockVideos;
exports.searchMockContents = searchMockContents;
